 ...
 * @param correct_parses All correct morphological parses of the previous words.
 ...
 * @param next_parse_list All possible parses of the next word.
 ...
 * @param index Position of the current word.
 * @param fsm_parses All morphological parses of the current sentence.
 * @param length Length of the sentence.
 ...
 * @param parse_string Disambiguation parse string. The string contains distinct subparses for the given word for a
                ...
                if (strcmp(parse_string, "A3PL+P3PL+NOM$A3PL+P3SG+NOM$A3PL+PNON+ACC$A3SG+P3PL+NOM") == 0) {
                    ...
                    if (strcmp(parse_string, "A3SG$PROP+A3SG") == 0) {
                        ...
                        if (strcmp(parse_string, "P2SG+NOM$PNON+GEN") == 0) {
                            ...
                            /* ÇOK */ /* FAZLA */
                            if (strcmp(parse_string, "ADJ$ADV$DET$POSTP+PCABL") == 0 ||
                                strcmp(parse_string, "ADJ$ADV$POSTP+PCABL") == 0) {
                                                    ...
                                                    if (strcmp(parse_string, "ADV$NOUN+A3SG+PNON+NOM") == 0) {
                                                        ...
                                                        if (strcmp(parse_string, "ADJ$ADV") == 0) {
                                                            ...
                                                            if (strcmp(parse_string, "P2SG$PNON") == 0) {
                                                                ...
                                                                /* etti, kırdı */
                                                                if (strcmp(parse_string,
                                                                           "NOUN+A3SG+PNON+NOM^DB+VERB+ZERO$VERB+POS") ==
                                                                    0) {
                                                                    if (is_before_last_word(index, length)) {
                                                                        return "VERB+POS";
                                                                    }
                                                                    ...
                                                                    if (strcmp(parse_string, "CONJ$POSTP+PCNOM") == 0) {
                                                                        ...
                                                                        /* gelecek */
                                                                        if (strcmp(parse_string,
                                                                                   "POS+FUT+A3SG$POS^DB+ADJ+FUTPART+PNON") ==
                                                                            0) {
                                                                            if (is_before_last_word(index, length)) {
                                                                                return "POS+FUT+A3SG";
                                                                            }
                                                                            ...
                                                                            if (strcmp(parse_string,
                                                                                       "ADJ^DB$NOUN+A3SG+PNON+NOM^DB") ==
                                                                                0) {
                                                                                if (string_in_list(root,
                                                                                                   (char *[]) {"yok",
                                                                                                               "düşük",
                                                                                                               "eksik",
                                                                                                               "rahat",
                                                                                ...
                                                                                if (strcmp(parse_string,
                                                                                    ...
                                                                                    /* ederim, yaparım */
                                                                                    if (strcmp(parse_string,
                                                                                               "AOR+A1SG$AOR^DB+ADJ+ZERO^DB+NOUN+ZERO+A3SG+P1SG+NOM") ==
                                                                                        0) {
                                                                                        return "AOR+A1SG";
                                                                                    } else {
                                                                                        /* geçti, vardı, aldı */
                                                                                        if (strcmp(parse_string,
                                                                                                   "ADJ^DB+VERB+ZERO$VERB+POS") ==
                                                                                            0) {
                                                                                            if (strcmp(root, "var") ==
                                                                                                0 &&
                                                                                                !is_possessive_plural(
                                                                                                        index,
                                                                                                        correct_parses)) {
                                                                                            ...
                                                                                            if (strcmp(parse_string,
                                                                                                ...
                                                                                                /* yaptığı, ettiği */
                                                                                                if (strcmp(parse_string,
                                                                                                           "ADJ+PASTPART+P3SG$NOUN+PASTPART+A3SG+P3SG+NOM") ==
                                                                                                    0) {
                                                                                                    if (is_next_word_noun_or_adjective(
                                                                                                            index,
                                                                                                            fsm_parses,
                                                                                                            length)) {
                                                                                                    ...
                                                                                                    if (strcmp(
                                                                                                            parse_string,
                                                                                                            "ADV$NOUN+A3SG+PNON+NOM$POSTP+PCABL") ==
                                                                                                        0) {
                                                                                                        if (has_previous_word_tag(
                                                                                                                index,
                                                                                                                correct_parses,
                                                                                                                ABLATIVE)) {
                                                                                                            return "POSTP+PCABL";
                                    ...
                                    if (strcmp(parse_string, "ADJ$ADV$NOUN+A3SG+PNON+NOM") == 0) {
                                        ...
                                        if (strcmp(parse_string, "P1SG+NOM$PNON+NOM^DB+VERB+ZERO+PRES+A1SG") == 0) {
                                            ...
                                            if (strcmp(parse_string,
                                                ...
                                                /* NE */
                                                if (strcmp(parse_string, "ADJ$ADV$CONJ$PRON+QUESP+A3SG+PNON+NOM") ==
                                                    0) {
                                                    ...
                                                    if (strcmp(parse_string, "DET$NOUN+A3SG+PNON+NOM") == 0) {
                                                        ...
                                                        /* AZ */
                                                        if (strcmp(parse_string,
                                                                   "ADJ$ADV$POSTP+PCABL$VERB+POS+IMP+A2SG") == 0) {
                                                            if (has_previous_word_tag(index, correct_parses,
                                                                                      ABLATIVE)) {
                                                                return "POSTP+PCABL";
                                                            }
                                                            if (is_next_word_noun_or_adjective(index, fsm_parses,
                                                                                               length)) {
                                                                return "ADJ";
                                                            }
                                                            return "ADV";
                                                            ...
                                                            if (strcmp(parse_string,
                                                                ...
                                                                if (strcmp(parse_string, "DATE$NUM+FRACTION") == 0) {
                                                                    ...
                                                                    if (strcmp(parse_string,
                                                                               "POS^DB+NOUN+INF3+A3SG+PNON+NOM$RECIP+POS+IMP+A2SG") ==
                                                                        0) {
                                                                        return "POS^DB+NOUN+INF3+A3SG+PNON+NOM";
                                                                    } else {
                                                                        /* başka, yukarı */
                                                                        if (strcmp(parse_string, "ADJ$POSTP+PCABL") ==
                                                                            0) {
                                                                            if (has_previous_word_tag(index,
                                                                                                      correct_parses,
                                                                                                      ABLATIVE)) {
                                                                                return "POSTP+PCABL";
                                                                            }
                                                                            ...
                                                                            /* KARŞI */
                                                                            if (strcmp(parse_string,
                                                                                       "ADJ$ADV$NOUN+A3SG+PNON+NOM$POSTP+PCDAT") ==
                                                                                0) {
                                                                                if (has_previous_word_tag(index,
                                                                                                          correct_parses,
                                                                                                          DATIVE)) {
                                                                                ...
                                                                                if (is_next_word_noun(index, fsm_parses,
                                                                                                      length)) {
                                                                                    return "ADJ";
                                                                                }
                                                                                return "ADV";
                                                                                ...
                                                                                /* BEN */
                                                                                if (strcmp(parse_string,
                                                                                           "NOUN+A3SG$NOUN+PROP+A3SG$PRON+PERS+A1SG") ==
                                                                                    0) {
                                                                                    return "PRON+PERS+A1SG";
                                                                                } else {
                                                                                    /* yapıcı, verici */
                                                                                    if (strcmp(parse_string,
                                                                                               "ADJ+AGT$NOUN+AGT+A3SG+PNON+NOM") ==
                                                                                        0) {
                                                                                        if (is_next_word_noun_or_adjective(
                                                                                                index, fsm_parses,
                                                                                                length)) {
                                                                                        ...
                                                                                        /* BİLE */
                                                                                        if (strcmp(parse_string,
                                                                                                   "ADV$VERB+POS+IMP+A2SG") ==
                                                                                            0) {
                                                                                            return "ADV";
                                                                                        } else {
                                                                                            /* ortalamalar, uzaylılar, demokratlar */
                                                                                            if (strcmp(parse_string,
                                                                                                       "NOUN+ZERO+A3PL+PNON+NOM$VERB+ZERO+PRES+A3PL") ==
                                                                                                0) {
                                                                                                return "NOUN+ZERO+A3PL+PNON+NOM";
                                                                                            } else {
                                                                                                /* yasa, diye, yıla */
                                                                                                if (strcmp(parse_string,
                                                                                                           "NOUN+A3SG+PNON+DAT$VERB+POS+OPT+A3SG") ==
                                                                                                    0) {
                                                                                                    ...
                                                                                                    if (strcmp(
                                                                                                        ...
                                                                                                        if (strcmp(
                                                                                                                parse_string,
                                                                                                                "ADJ^DB+VERB+ZERO$POSTP+PCABL^DB+VERB+ZERO$VERB+POS") ==
                                                                                                            0) {
                                                                                                            return "ADJ^DB+VERB+ZERO";
                                                                                                        } else {
    ...
    if (strcmp(parse_string, "INTERJ$NOUN+A3SG+PNON+NOM$VERB+POS+IMP+A2SG") == 0) {
        ...
        if (strcmp(parse_string, "NEG+AOR+A1SG$POS^DB+NOUN+INF2+A3SG+P1SG+NOM") == 0) {
            ...
            if (strcmp(parse_string, "CONJ$INTERJ") == 0) {
                ...
                if (next_word_exists(index, length) &&
                    strcmp(((Fsm_parse_ptr) array_list_get(fsm_parses[index + 1]->fsm_parses, 0))->form, "da") == 0) {
                    return "CONJ";
                }
                return "INTERJ";
            } else {
                                ...
                                if (strcmp(parse_string, "NOUN+A3SG+PNON$PRON+QUANTP+A3PL+P3PL") == 0) {
                                    ...
                                    if (strcmp(parse_string, "NOUN+A3SG$PRON+PERS+A1SG") == 0) {
                                        ...
                                        if (strcmp(parse_string, "ADJ^DB+NOUN+ZERO$NOUN") == 0) {
                                            ...
                                            /* gideceği, kalacağı */
                                            if (strcmp(parse_string, "ADJ+FUTPART+P3SG$NOUN+FUTPART+A3SG+P3SG+NOM") ==
                                                0) {
                                                if (is_next_word_noun_or_adjective(index, fsm_parses, length)) {
                                                ...
                                                if (strcmp(parse_string,
                                                           "ADJ+PASTPART+P1PL$NOUN+PASTPART+A3SG+P1PL+NOM") == 0) {
                                                    return "ADJ+PASTPART+P1PL";
                                                } else {
                                                    /* eminim, memnunum, açım */
                                                    if (strcmp(parse_string,
                                                               "NOUN+ZERO+A3SG+P1SG+NOM$VERB+ZERO+PRES+A1SG") == 0) {
                                                            ...
                                                            if (strcmp(parse_string,
                                                                ...
                                                                if (strcmp(parse_string,
                                                                    ...
                                                                    if (strcmp(parse_string,
                                                                        ...
                                                                        if (is_next_word_noun_or_adjective(index,
                                                                                                           fsm_parses,
                                                                                                           length)) {
                                                                        ...
                                                                        /* DE */
                                                                        if (strcmp(parse_string,
                                                                                   "CONJ$NOUN+PROP+A3SG+PNON+NOM$VERB+POS+IMP+A2SG") ==
                                                                            0) {
                                                                            if (index > 0) {
                                                                                return "NOUN+PROP+A3SG+PNON+NOM";
                                                                            }
                                                                            ...
                                                                            /* GEÇ, SIK */
                                                                            if (strcmp(parse_string,
                                                                                       "ADJ$ADV$VERB+POS+IMP+A2SG") ==
                                                                                0) {
                                                                                if (strcmp(surfaceForm, "sık") == 0) {
                                                                                    char *previousWord;
                                                                                    char *nextWord;
                                                                                    if (index - 1 > -1) {
                                                                                        previousWord = ((Fsm_parse_ptr) array_list_get(
                                                                                                fsm_parses[index -
                                                                                                           1]->fsm_parses,
                                                                                                0))->form;
                                                                                    }
                                                                                    if (index + 1 < length) {
                                                                                        nextWord = ((Fsm_parse_ptr) array_list_get(
                                                                                                fsm_parses[index +
                                                                                                           1]->fsm_parses,
                                                                                                0))->form;
                                                                                    }
                                                                                    if (strcmp(previousWord, "sık") ==
                                                                                        0 ||
                                                                                        strcmp(nextWord, "sık") == 0) {
                                                                                        return "ADV";
                                                                                    }
                                                                                }
                                                                                if (is_next_word_noun(index, fsm_parses,
                                                                                ...
                                                                                if (strcmp(parse_string,
                                                                                    ...
                                                                                    if (strcmp(parse_string,
                                                                                               "ADJ+ASIF$ADV+LY$NOUN+ZERO+A3SG+PNON+EQU") ==
                                                                                        0) {
                                                                                        return "ADV+LY";
                                                                                    } else {
                                                                                            ...
                                                                                            if (strcmp(parse_string,
                                                                                                ...
                                                                                                if (strcmp(parse_string,
                                                                                                    ...
                                                                                                    if (strcmp(
                                                                                                        ...
                                                                                                        if (strcmp(
                                                                                                                parse_string,
                                                                                                                "NOUN+A3SG+PNON$PRON+QUANTP+A3SG+P3SG") ==
                                                                                                            0) {
                                                                                                            ...
                                                                                                            if (strcmp(
                                                                                                                    parse_string,
                                                                                                                    "ADJ$NOUN+A3SG+PNON+NOM$POSTP+PCDAT") ==
                                                                                                                0) {
                                                                                                                if (has_previous_word_tag(
                                                                                                                        index,
                                                                                                                        correct_parses,
    ...
    if (strcmp(parse_string, "ADJ+JUSTLIKE^DB+NOUN+ZERO+A3SG+P2SG$NOUN+ZERO+A3SG+P3SG") == 0) {
        ...
        if (strcmp(parse_string,
            ...
            if (strcmp(parse_string, "ADV$PRON+QUANTP+A3SG+P3SG+NOM") == 0) {
                ...
                /* O */
                if (strcmp(parse_string,
                           "DET$NOUN+PROP+A3SG+PNON+NOM$PRON+DEMONSP+A3SG+PNON+NOM$PRON+PERS+A3SG+PNON+NOM") == 0) {
                    if (is_next_word_noun(index, fsm_parses, length)) {
                        return "DET";
                    } else {
                        return "PRON+PERS+A3SG+PNON+NOM";
                    ...
                    if (strcmp(parse_string,
                               "POS+NECES$POS^DB+NOUN+INF2+A3SG+PNON+NOM^DB+ADJ+WITH^DB+VERB+ZERO+PRES") == 0) {
                        return "POS+NECES";
                    } else {
                        /* kızdı, çekti, bozdu */
                        if (strcmp(parse_string, "ADJ^DB+VERB+ZERO$NOUN+A3SG+PNON+NOM^DB+VERB+ZERO$VERB+POS") == 0) {
                            ...
                            if (strcmp(parse_string, "NOUN+A3SG+P1SG$PRON+PERS+A1PL+PNON") == 0) {
                                ...
                                /* VARDIR */
                                if (strcmp(parse_string,
                                           "ADJ^DB+VERB+ZERO+PRES+COP+A3SG$VERB^DB+VERB+CAUS+POS+IMP+A2SG") == 0) {
                                    ...
                                    if (strcmp(parse_string, "NOUN+A3SG+PNON+NOM$QUES+PRES+A3SG") == 0) {
                                        ...
                                        if (strcmp(parse_string,
                                            ...
                                            /* SUN */
                                            if (strcmp(parse_string, "NOUN+PROP+A3SG+PNON+NOM$VERB+POS+IMP+A2SG") ==
                                                0) {
                                                return "NOUN+PROP+A3SG+PNON+NOM";
                                            } else {
                                                if (strcmp(parse_string,
                                                    ...
                                                    if (strcmp(parse_string,
                                                        ...
                                                        if (strcmp(parse_string,
                                                            ...
                                                            if (strcmp(parse_string,
                                                                ...
                                                                /* A */
                                                                if (strcmp(parse_string,
                                                                           "ADJ$INTERJ$NOUN+PROP+A3SG+PNON+NOM") == 0) {
                                                                    return "NOUN+PROP+A3SG+PNON+NOM";
                                                                } else {
                                                                    /* BİZİ */
                                                                    if (strcmp(parse_string,
                                                                        ...
                                                                        if (strcmp(parse_string,
                                                                            ...
                                                                            if (strcmp(parse_string,
                                                                                ...
                                                                                if (strcmp(parse_string,
                                                                                    ...
                                                                                    if (strcmp(parse_string,
                                                                                               "AOR+A2PL$AOR^DB+ADJ+ZERO^DB+ADJ+JUSTLIKE^DB+NOUN+ZERO+A3SG+P2PL+NOM") ==
                                                                                        0) {
                                                                                        return "AOR+A2PL";
                                                                                    } else {
                                                                                        /* ayın, düşünün*/
                                                                                        if (strcmp(parse_string,
                                                                                            ...
                                                                                            if (strcmp(parse_string,
                                                                                                       "POS+FUT+A3PL$POS^DB+NOUN+FUTPART+A3PL+PNON+NOM") ==
                                                                                                0) {
                                                                                                return "POS+FUT+A3PL";
                                                                                            } else {
                                                                                                /* 9:30'daki */
            ...
            if (strcmp(parse_string, "NEG+FUT+A1SG$NEG^DB+ADJ+FUTPART+P1SG$NEG^DB+NOUN+FUTPART+A3SG+P1SG+NOM") == 0) {
                ...
                if (strcmp(parse_string, "POS^DB+NOUN+INF3+A3SG+PNON+DAT$RECIP+POS+OPT+A3SG") == 0) {
                    ...
                    if (strcmp(parse_string,
                        ...
                        /* BENİ */
                        if (strcmp(parse_string, "NOUN+A3SG+P3SG+NOM$NOUN+A3SG+PNON+ACC$PRON+PERS+A1SG+PNON+ACC") ==
                            0) {
                            return "PRON+PERS+A1SG+PNON+ACC";
                        } else {
                            /* edemezsin, kanıtlarsın, yapamazsın */
                            if (strcmp(parse_string,
                                       "AOR+A2SG$AOR^DB+ADJ+ZERO^DB+ADJ+JUSTLIKE^DB+NOUN+ZERO+A3SG+P2SG+NOM") == 0) {
                                return "AOR+A2SG";
                            } else {
                                        ...
                                        if (strcmp(parse_string,
                                            ...
                                            if (strcmp(parse_string,
                                                ...
                                                if (strcmp(parse_string, "VERB+POS+AOR$VERB^DB+VERB+CAUS+POS") == 0) {
                                                    ...
                                                    if (strcmp(parse_string,
                                                               "P1PL+NOM$P1SG+NOM^DB+VERB+ZERO+PRES+A1PL") == 0) {
                                                        return "P1PL+NOM";
                                                    } else {
                                                        ...
                                                        if (strcmp(parse_string,
                                                            ...
                                                            if (strcmp(parse_string, "VERB+REFLEX$VERB^DB+VERB+PASS") ==
                                                                0) {
                                                                ...
                                                                if (strcmp(parse_string,
                                                                    ...
                                                                    if (strcmp(parse_string,
                                                                        ...
                                                                        0) {
                                                                        if (is_next_word_num(index, fsm_parses,
                                                                                             length)) {
                                                                            return "NUM+CARD";
                                                                        }
                                                                        return "NOUN+A3SG+PNON+NOM";
                                                                        ...
                                                                        if (strcmp(parse_string,
                                                                            ...
                                                                            if (strcmp(parse_string,
                                                                                ...
                                                                                0) {
                                                                                if (is_any_word_second_person(index,
                                                                                                              correct_parses)) {
                                                                                ...
                                                                                /* VARSA */
                                                                                if (strcmp(parse_string,
                                                                                           "ADJ^DB+VERB+ZERO+COND$VERB+POS+DESR") ==
                                                                                    0) {
                                                                                    return "ADJ^DB+VERB+ZERO+COND";
                                                                                } else {
                                                                                    /* DEK */
                                                                                    if (strcmp(parse_string,
                                                                                               "NOUN+A3SG+PNON+NOM$POSTP+PCDAT") ==
                                                                                        0) {
                                                                                        return "POSTP+PCDAT";
                                                                                    } else {
                                                                                        /* ALDIK */
                                                                                                    ...
                                                                                                    if (strcmp(
                                                                                                        ...
                                                                                                        if (strcmp(
                                                                                                            ...
                                                                                                            if (strcmp(
                                                                                                                ...
                                                                                                                if (strcmp(
                                                                                                                        parse_string,
                                                                                                                        "CONJ$NOUN+A3SG+PNON+NOM$VERB+POS+IMP+A2SG") ==
                                                                                                                    0) {
                                                                                                                    if (contains_two_ne_or_ya(
                                                                                                                            fsm_parses,
                                                                                                                            "gerek",
                                                                                                                            length)) {
                                                                                                                        return "CONJ";
            ...
            if (strcmp(parse_string, "NOUN+PROP$PRON+QUESP") == 0) {
                ...
                if (strcmp(parse_string,
                    ...
                    if (strcmp(parse_string,
                        ...
                        if (strcmp(parse_string, "POS+NECES$POS^DB+NOUN+INF2+A3SG+PNON+NOM^DB+ADJ+WITH^DB+VERB+ZERO") ==
                            0) {
                            return "POS+NECES";
                        } else {
                            /* HERKESİN */
                            if (strcmp(parse_string,
                                       "NOUN+A3SG+P2SG+NOM$NOUN+A3SG+PNON+GEN$PRON+QUANTP+A3PL+P3PL+GEN") == 0) {
                                ...
                                if (strcmp(parse_string,
                                    ...
                                    if (strcmp(parse_string, "NESS+A3SG+PNON+NOM$ZERO+A3SG+PNON+NOM^DB+ADJ+FITFOR") ==
                                        0) {
                                        return "ZERO+A3SG+PNON+NOM^DB+ADJ+FITFOR";
                                    } else {
                                        /* alınmamaktadır, koymamaktadır */
                                        if (strcmp(parse_string,
                                                   "NEG+PROG2$NEG^DB+NOUN+INF+A3SG+PNON+LOC^DB+VERB+ZERO+PRES") == 0) {
                                            return "NEG+PROG2";
                                        } else {
                                            /* HEPİMİZ */
                                            if (strcmp(parse_string,
                                                       "A1PL+P1PL+NOM$A3SG+P3SG+GEN^DB+VERB+ZERO+PRES+A1PL") == 0) {
                                                            ...
                                                            if (strcmp(parse_string,
                                                                ...
                                                                if (strcmp(parse_string,
                                                                    ...
                                                                    if (strcmp(parse_string,
                                                                        ...
                                                                        if (strcmp(parse_string,
                                                                                   "A3PL+P3SG$A3SG+P3PL$PROP+A3PL+P3PL") ==
                                                                            0) {
                                                                            return "PROP+A3PL+P3PL";
                                                                        } else {
                                                                            /* pilotunuz, suçunuz, haberiniz */
                                                                            if (strcmp(parse_string,
                                                                                       "P2PL+NOM$PNON+GEN^DB+VERB+ZERO+PRES+A1PL") ==
                                                                                0) {
                                                                                return "P2PL+NOM";
                                                                            } else {
                                                                                ...
                                                                                if (strcmp(parse_string,
                                                                                    ...
                                                                                    /* gerçekçi, alıcı */
                                                                                    if (strcmp(parse_string,
                                                                                               "ADJ^DB+NOUN+AGT+A3SG+PNON+NOM$NOUN+A3SG+PNON+NOM^DB+ADJ+AGT") ==
                                                                                        0) {
                                                                                        if (is_next_word_noun_or_adjective(
                                                                                                index, fsm_parses,
                                                                                                length)) {
                                                                                        ...
                                                                                        if (strcmp(parse_string,
                                                                                            ...
                                                                                            /* olun, kurtulun, gelin */
                                                                                            if (strcmp(parse_string,
                                                                                                       "VERB+POS+IMP+A2PL$VERB^DB+VERB+PASS+POS+IMP+A2SG") ==
                                                                                                0) {
                                                                                                return "VERB+POS+IMP+A2PL";
                                                                                            } else {
                                                                                                if (strcmp(parse_string,
                                                                                                    ...
                                                                                                    if (strcmp(
                                                                                                            parse_string,
                                                                                                            "POS+PROG2$POS^DB+NOUN+INF+A3SG+PNON+LOC^DB+VERB+ZERO") ==
                                                                                                        0) {
                                                                                                        return "POS+PROG2";
                                                                                                    } else {
                                                                                                        /* BERABER */
            ...
            if (strcmp(parse_string, "ADV+WITHOUTHAVINGDONESO$NOUN+INF2+A3SG+PNON+ABL") == 0) {
                ...
                if (strcmp(parse_string,
                    ...
                    if (strcmp(parse_string, "P3SG+NOM$PNON+ACC") == 0) {
                        if (strcmp(((Fsm_parse_ptr) array_list_get(fsm_parses[index]->fsm_parses, 0))->pos, "PROP") ==
                            0) {
                            return "PNON+ACC";
                        } else {
                            return "P3SG+NOM";
                                        ...
                                        if (strcmp(parse_string, "NEG+OPT+A3SG$POS^DB+NOUN+INF2+A3SG+PNON+DAT") == 0) {
                                            ...
                                            if (strcmp(parse_string, "NOUN+A3SG+P3SG+NOM$NOUN^DB+ADJ+ALMOST") == 0) {
                                                ...
                                                if (strcmp(parse_string, "ADJ$VERB+POS+IMP+A2SG") == 0) {
                                                    ...
                                                    if (strcmp(parse_string, "NOUN+A3SG+PNON+NOM$VERB+POS+IMP+A2SG") ==
                                                        0) {
                                                        return "NOUN+A3SG+PNON+NOM";
                                                    } else {
                                                        if (strcmp(parse_string,
                                                                   "INF2+A3SG+P3SG+NOM$INF2^DB+ADJ+ALMOST$") == 0) {
